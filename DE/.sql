...
--------------------------------------------------------
  ...
  CREATE TABLE "SYSTEM"."BLACKLIST" 
   (	"ID" NUMBER(38,0), 
	...
	"MUTED_USERID" VARCHAR2(255 BYTE), 
	"ADD_AT" TIMESTAMP (6) DEFAULT CURRENT_TIMESTAMP
...
--------------------------------------------------------
  ...
  CREATE TABLE "SYSTEM"."FOLLOWER" 
   (	"ID" NUMBER(38,0), 
	"USERID" VARCHAR2(255 BYTE), 
	"FOLLOWEDID" VARCHAR2(255 BYTE), 
...
--------------------------------------------------------
  ...
  CREATE TABLE "SYSTEM"."COMMENTS" 
   (	"COMMENTID" NUMBER(38,0) GENERATED BY DEFAULT AS IDENTITY MINVALUE 1 MAXVALUE 9999999999999999999999999999 INCREMENT BY 1 START WITH 1 CACHE 20 NOORDER  NOCYCLE  NOKEEP  NOSCALE , 
...
--------------------------------------------------------
--  DDL for Table PERSONALIZATION
--------------------------------------------------------

  CREATE TABLE "SYSTEM"."PERSONALIZATION" 
   (	"ID" NUMBER(38,0), 
	"USERID" VARCHAR2(255 BYTE), 
	"AVATAR" VARCHAR2(255 BYTE), 
	"NAME" VARCHAR2(50 BYTE), 
	"PRONOUNS" VARCHAR2(50 BYTE), 
	"SHORT_BIO" VARCHAR2(160 BYTE)
   ) PCTFREE 10 PCTUSED 40 INITRANS 1 MAXTRANS 255 
 NOCOMPRESS LOGGING
  STORAGE(INITIAL 65536 NEXT 1048576 MINEXTENTS 1 MAXEXTENTS 2147483645
  PCTINCREASE 0 FREELISTS 1 FREELIST GROUPS 1
...
--------------------------------------------------------
  ...
  CREATE TABLE "SYSTEM"."POST" 
   (	"POSTID" NUMBER(38,0), 
	...
	"CONTENT" CLOB, 
	"POST_AT" TIMESTAMP (6) DEFAULT CURRENT_TIMESTAMP
   ) PCTFREE 10 PCTUSED 40 INITRANS 1 MAXTRANS 255 
 NOCOMPRESS LOGGING
  STORAGE(INITIAL 65536 NEXT 1048576 MINEXTENTS 1 MAXEXTENTS 2147483645
  PCTINCREASE 0 FREELISTS 1 FREELIST GROUPS 1
 ...
 LOB ("CONTENT") STORE AS BASICFILE (
  ...
  BUFFER_POOL DEFAULT FLASH_CACHE DEFAULT CELL_FLASH_CACHE DEFAULT)) ;
--------------------------------------------------------
--  DDL for Table READING_HISTORY
--------------------------------------------------------

  CREATE TABLE "SYSTEM"."READING_HISTORY" 
   (	"ID" NUMBER(38,0), 
	"USERID" VARCHAR2(255 BYTE), 
	"POSTID" NUMBER(38,0), 
	"VIEW_AT" TIMESTAMP (6) DEFAULT CURRENT_TIMESTAMP
   ) PCTFREE 10 PCTUSED 40 INITRANS 1 MAXTRANS 255 
 NOCOMPRESS LOGGING
  STORAGE(INITIAL 65536 NEXT 1048576 MINEXTENTS 1 MAXEXTENTS 2147483645
  PCTINCREASE 0 FREELISTS 1 FREELIST GROUPS 1
  ...
  TABLESPACE "SYSTEM" ;
--------------------------------------------------------
--  DDL for Table READING_LIST
--------------------------------------------------------

  CREATE TABLE "SYSTEM"."READING_LIST" 
   (	"ID" NUMBER(38,0), 
	"USERID" VARCHAR2(255 BYTE), 
	"USER_LISTS" VARCHAR2(20 BYTE), 
	"POSTID" NUMBER, 
	"PUBLISHED" VARCHAR2(5 BYTE)
   ) PCTFREE 10 PCTUSED 40 INITRANS 1 MAXTRANS 255 
 NOCOMPRESS LOGGING
  STORAGE(INITIAL 65536 NEXT 1048576 MINEXTENTS 1 MAXEXTENTS 2147483645
  PCTINCREASE 0 FREELISTS 1 FREELIST GROUPS 1
  ...
  TABLESPACE "SYSTEM" ;
--------------------------------------------------------
--  DDL for Table READING_LIST_POST
--------------------------------------------------------

  CREATE TABLE "SYSTEM"."READING_LIST_POST" 
   (	"READING_LIST_ID" NUMBER(38,0), 
	"POSTID" NUMBER(38,0)
   ) PCTFREE 10 PCTUSED 40 INITRANS 1 MAXTRANS 255 
 NOCOMPRESS LOGGING
  STORAGE(INITIAL 65536 NEXT 1048576 MINEXTENTS 1 MAXEXTENTS 2147483645
  ...
  TABLESPACE "SYSTEM" ;
--------------------------------------------------------
--  DDL for Table RELEVANCY_POST_TAG
--------------------------------------------------------

  CREATE TABLE "SYSTEM"."RELEVANCY_POST_TAG" 
   (	"ID" NUMBER(38,0), 
	"POSTID" NUMBER(38,0), 
	"TAGID" NUMBER(38,0)
   ) PCTFREE 10 PCTUSED 40 INITRANS 1 MAXTRANS 255 
...
--------------------------------------------------------
  ...
  CREATE TABLE "SYSTEM"."SETTING" 
   (	"ID" NUMBER(38,0), 
	"USERID" VARCHAR2(255 BYTE), 
	"HEADER_COLOR" VARCHAR2(22 BYTE) DEFAULT 'rgba(255,255,255,1)', 
	"HEADER_IMG" VARCHAR2(255 BYTE), 
	"NAME_TXT_LOGO" VARCHAR2(255 BYTE) DEFAULT 'rgba(0,0,0,1)', 
	"BLOG_ROLL" VARCHAR2(5 BYTE), 
	"SETTING_AT" TIMESTAMP (6) DEFAULT CURRENT_TIMESTAMP
   ) PCTFREE 10 PCTUSED 40 INITRANS 1 MAXTRANS 255 
 NOCOMPRESS LOGGING
  STORAGE(INITIAL 65536 NEXT 1048576 MINEXTENTS 1 MAXEXTENTS 2147483645
  PCTINCREASE 0 FREELISTS 1 FREELIST GROUPS 1
...
--------------------------------------------------------
 ...
 NOCOMPRESS LOGGING
  ...
  BUFFER_POOL DEFAULT FLASH_CACHE DEFAULT CELL_FLASH_CACHE DEFAULT)
  TABLESPACE "SYSTEM" ;
REM INSERTING into SYSTEM.BLACKLIST
SET DEFINE OFF;
REM INSERTING into SYSTEM."Like"
SET DEFINE OFF;
REM INSERTING into SYSTEM.FOLLOWER
SET DEFINE OFF;
...
REM INSERTING into SYSTEM.PERSONALIZATION
SET DEFINE OFF;
Insert into SYSTEM.PERSONALIZATION (ID,USERID,AVATAR,NAME,PRONOUNS,SHORT_BIO) values (21,'100180980463583460552','https://lh3.googleusercontent.com/a/ACg8ocKOipNPscAJECgOvX3KmcBUt4V7dpZqgRO6gahKg96v-IsqbTc=s96-c',null,null,null);
REM INSERTING into SYSTEM.POST
SET DEFINE OFF;
REM INSERTING into SYSTEM.READING_HISTORY
SET DEFINE OFF;
REM INSERTING into SYSTEM.READING_LIST
SET DEFINE OFF;
REM INSERTING into SYSTEM.READING_LIST_POST
SET DEFINE OFF;
REM INSERTING into SYSTEM.RELEVANCY_POST_TAG
SET DEFINE OFF;
REM INSERTING into SYSTEM.SETTING
SET DEFINE OFF;
REM INSERTING into SYSTEM.TAG
SET DEFINE OFF;
REM INSERTING into SYSTEM.TEST
SET DEFINE OFF;
REM INSERTING into SYSTEM."Users"
SET DEFINE OFF;
Insert into SYSTEM."Users" (ID,GOOGLE_ID,NAME,EMAIL,PROVIDER,REFRESH_TOKEN,CREATED_AT) values (1,'000000','TestAccount','test@gmail.com','GOOGLE',null,to_timestamp('11-3月 -25 03.42.20.946374000 下午','DD-MON-RR HH.MI.SSXFF AM'));
Insert into SYSTEM."Users" (ID,GOOGLE_ID,NAME,EMAIL,PROVIDER,REFRESH_TOKEN,CREATED_AT) values (42,'100180980463583460552','邱勝夫','aenevia666@gmail.com','google','eyJhbGciOiJIUzI1NiJ9.eyJzdWIiOiIxMDAxODA5ODA0NjM1ODM0NjA1NTIiLCJpYXQiOjE3NDM0NjYwNzIsImV4cCI6MTc0NjA1ODA3Mn0.q0iUvfVZbkKBEytGa8IyUNZsOjP5qFZ95xuGaaOIDyo',to_timestamp('18-3月 -25 04.55.10.485821000 下午','DD-MON-RR HH.MI.SSXFF AM'));
--------------------------------------------------------
--  DDL for Index SYS_C008349
--------------------------------------------------------

  CREATE UNIQUE INDEX "SYSTEM"."SYS_C008349" ON "SYSTEM"."BLACKLIST" ("ID") 
  ...
  TABLESPACE "SYSTEM" ;
--------------------------------------------------------
--  DDL for Index BLACKLIST_UNIQUE_USERID
--------------------------------------------------------

  CREATE UNIQUE INDEX "SYSTEM"."BLACKLIST_UNIQUE_USERID" ON "SYSTEM"."BLACKLIST" ("USERID") 
  PCTFREE 10 INITRANS 2 MAXTRANS 255 COMPUTE STATISTICS 
  STORAGE(INITIAL 65536 NEXT 1048576 MINEXTENTS 1 MAXEXTENTS 2147483645
  PCTINCREASE 0 FREELISTS 1 FREELIST GROUPS 1
  BUFFER_POOL DEFAULT FLASH_CACHE DEFAULT CELL_FLASH_CACHE DEFAULT)
...
--------------------------------------------------------
  ...
  CREATE UNIQUE INDEX "SYSTEM"."SYS_C008338" ON "SYSTEM"."Like" ("LIKEID") 
  PCTFREE 10 INITRANS 2 MAXTRANS 255 COMPUTE STATISTICS 
  STORAGE(INITIAL 65536 NEXT 1048576 MINEXTENTS 1 MAXEXTENTS 2147483645
  PCTINCREASE 0 FREELISTS 1 FREELIST GROUPS 1
  BUFFER_POOL DEFAULT FLASH_CACHE DEFAULT CELL_FLASH_CACHE DEFAULT)
  TABLESPACE "SYSTEM" ;
--------------------------------------------------------
--  DDL for Index LIKE_UNIQUE_USERID
--------------------------------------------------------

  CREATE UNIQUE INDEX "SYSTEM"."LIKE_UNIQUE_USERID" ON "SYSTEM"."Like" ("USERID") 
  PCTFREE 10 INITRANS 2 MAXTRANS 255 COMPUTE STATISTICS 
  STORAGE(INITIAL 65536 NEXT 1048576 MINEXTENTS 1 MAXEXTENTS 2147483645
  PCTINCREASE 0 FREELISTS 1 FREELIST GROUPS 1
  BUFFER_POOL DEFAULT FLASH_CACHE DEFAULT CELL_FLASH_CACHE DEFAULT)
...
--------------------------------------------------------
  ...
  CREATE UNIQUE INDEX "SYSTEM"."SYS_C008322" ON "SYSTEM"."FOLLOWER" ("ID") 
  PCTFREE 10 INITRANS 2 MAXTRANS 255 COMPUTE STATISTICS 
  STORAGE(INITIAL 65536 NEXT 1048576 MINEXTENTS 1 MAXEXTENTS 2147483645
  PCTINCREASE 0 FREELISTS 1 FREELIST GROUPS 1
  BUFFER_POOL DEFAULT FLASH_CACHE DEFAULT CELL_FLASH_CACHE DEFAULT)
  TABLESPACE "SYSTEM" ;
--------------------------------------------------------
--  DDL for Index FOLLOWER_COMPOSITE_CONSTRAINT
--------------------------------------------------------

  CREATE UNIQUE INDEX "SYSTEM"."FOLLOWER_COMPOSITE_CONSTRAINT" ON "SYSTEM"."FOLLOWER" ("USERID", "FOLLOWEDID") 
  PCTFREE 10 INITRANS 2 MAXTRANS 255 COMPUTE STATISTICS 
  STORAGE(INITIAL 65536 NEXT 1048576 MINEXTENTS 1 MAXEXTENTS 2147483645
  PCTINCREASE 0 FREELISTS 1 FREELIST GROUPS 1
  BUFFER_POOL DEFAULT FLASH_CACHE DEFAULT CELL_FLASH_CACHE DEFAULT)
...
--------------------------------------------------------
  ...
  CREATE UNIQUE INDEX "SYSTEM"."SYS_C008411" ON "SYSTEM"."COMMENTS" ("COMMENTID") 
  PCTFREE 10 INITRANS 2 MAXTRANS 255 COMPUTE STATISTICS 
  STORAGE(INITIAL 65536 NEXT 1048576 MINEXTENTS 1 MAXEXTENTS 2147483645
  PCTINCREASE 0 FREELISTS 1 FREELIST GROUPS 1
  BUFFER_POOL DEFAULT FLASH_CACHE DEFAULT CELL_FLASH_CACHE DEFAULT)
...
--------------------------------------------------------
  ...
  CREATE UNIQUE INDEX "SYSTEM"."SYS_C008320" ON "SYSTEM"."PERSONALIZATION" ("ID") 
  PCTFREE 10 INITRANS 2 MAXTRANS 255 COMPUTE STATISTICS 
  STORAGE(INITIAL 65536 NEXT 1048576 MINEXTENTS 1 MAXEXTENTS 2147483645
  PCTINCREASE 0 FREELISTS 1 FREELIST GROUPS 1
  BUFFER_POOL DEFAULT FLASH_CACHE DEFAULT CELL_FLASH_CACHE DEFAULT)
...
--------------------------------------------------------
  ...
  CREATE UNIQUE INDEX "SYSTEM"."SYS_C008324" ON "SYSTEM"."POST" ("POSTID") 
  PCTFREE 10 INITRANS 2 MAXTRANS 255 COMPUTE STATISTICS 
  STORAGE(INITIAL 65536 NEXT 1048576 MINEXTENTS 1 MAXEXTENTS 2147483645
  PCTINCREASE 0 FREELISTS 1 FREELIST GROUPS 1
  BUFFER_POOL DEFAULT FLASH_CACHE DEFAULT CELL_FLASH_CACHE DEFAULT)
...
--------------------------------------------------------
  ...
  CREATE UNIQUE INDEX "SYSTEM"."SYS_C008332" ON "SYSTEM"."READING_HISTORY" ("ID") 
  PCTFREE 10 INITRANS 2 MAXTRANS 255 COMPUTE STATISTICS 
  STORAGE(INITIAL 65536 NEXT 1048576 MINEXTENTS 1 MAXEXTENTS 2147483645
  PCTINCREASE 0 FREELISTS 1 FREELIST GROUPS 1
  BUFFER_POOL DEFAULT FLASH_CACHE DEFAULT CELL_FLASH_CACHE DEFAULT)
  TABLESPACE "SYSTEM" ;
--------------------------------------------------------
--  DDL for Index READINGLIST_UNIQUE_USERID
--------------------------------------------------------

  CREATE UNIQUE INDEX "SYSTEM"."READINGLIST_UNIQUE_USERID" ON "SYSTEM"."READING_LIST" ("USERID") 
  PCTFREE 10 INITRANS 2 MAXTRANS 255 COMPUTE STATISTICS 
  STORAGE(INITIAL 65536 NEXT 1048576 MINEXTENTS 1 MAXEXTENTS 2147483645
  PCTINCREASE 0 FREELISTS 1 FREELIST GROUPS 1
  BUFFER_POOL DEFAULT FLASH_CACHE DEFAULT CELL_FLASH_CACHE DEFAULT)
...
--------------------------------------------------------
  ...
  CREATE UNIQUE INDEX "SYSTEM"."SYS_C008327" ON "SYSTEM"."READING_LIST" ("ID") 
  PCTFREE 10 INITRANS 2 MAXTRANS 255 COMPUTE STATISTICS 
  STORAGE(INITIAL 65536 NEXT 1048576 MINEXTENTS 1 MAXEXTENTS 2147483645
  PCTINCREASE 0 FREELISTS 1 FREELIST GROUPS 1
  BUFFER_POOL DEFAULT FLASH_CACHE DEFAULT CELL_FLASH_CACHE DEFAULT)
...
--------------------------------------------------------
  ...
  CREATE UNIQUE INDEX "SYSTEM"."SYS_C008345" ON "SYSTEM"."RELEVANCY_POST_TAG" ("ID") 
  PCTFREE 10 INITRANS 2 MAXTRANS 255 COMPUTE STATISTICS 
  STORAGE(INITIAL 65536 NEXT 1048576 MINEXTENTS 1 MAXEXTENTS 2147483645
  PCTINCREASE 0 FREELISTS 1 FREELIST GROUPS 1
  BUFFER_POOL DEFAULT FLASH_CACHE DEFAULT CELL_FLASH_CACHE DEFAULT)
  TABLESPACE "SYSTEM" ;
--------------------------------------------------------
--  DDL for Index SETTING_UNIQUE_USERID
--------------------------------------------------------

  CREATE UNIQUE INDEX "SYSTEM"."SETTING_UNIQUE_USERID" ON "SYSTEM"."SETTING" ("USERID") 
  PCTFREE 10 INITRANS 2 MAXTRANS 255 COMPUTE STATISTICS 
  STORAGE(INITIAL 65536 NEXT 1048576 MINEXTENTS 1 MAXEXTENTS 2147483645
  PCTINCREASE 0 FREELISTS 1 FREELIST GROUPS 1
  BUFFER_POOL DEFAULT FLASH_CACHE DEFAULT CELL_FLASH_CACHE DEFAULT)
...
--------------------------------------------------------
  ...
  CREATE UNIQUE INDEX "SYSTEM"."SYS_C008318" ON "SYSTEM"."SETTING" ("ID") 
  PCTFREE 10 INITRANS 2 MAXTRANS 255 COMPUTE STATISTICS 
  STORAGE(INITIAL 65536 NEXT 1048576 MINEXTENTS 1 MAXEXTENTS 2147483645
  PCTINCREASE 0 FREELISTS 1 FREELIST GROUPS 1
  BUFFER_POOL DEFAULT FLASH_CACHE DEFAULT CELL_FLASH_CACHE DEFAULT)
...
--------------------------------------------------------
  ...
  CREATE UNIQUE INDEX "SYSTEM"."SYS_C008341" ON "SYSTEM"."TAG" ("ID") 
  PCTFREE 10 INITRANS 2 MAXTRANS 255 COMPUTE STATISTICS 
  STORAGE(INITIAL 65536 NEXT 1048576 MINEXTENTS 1 MAXEXTENTS 2147483645
  PCTINCREASE 0 FREELISTS 1 FREELIST GROUPS 1
  BUFFER_POOL DEFAULT FLASH_CACHE DEFAULT CELL_FLASH_CACHE DEFAULT)
...
--------------------------------------------------------
  ...
  CREATE UNIQUE INDEX "SYSTEM"."SYS_C008342" ON "SYSTEM"."TAG" ("LABEL") 
  PCTFREE 10 INITRANS 2 MAXTRANS 255 COMPUTE STATISTICS 
  STORAGE(INITIAL 65536 NEXT 1048576 MINEXTENTS 1 MAXEXTENTS 2147483645
  PCTINCREASE 0 FREELISTS 1 FREELIST GROUPS 1
  BUFFER_POOL DEFAULT FLASH_CACHE DEFAULT CELL_FLASH_CACHE DEFAULT)
...
--------------------------------------------------------
  ...
  CREATE UNIQUE INDEX "SYSTEM"."SYS_C008404" ON "SYSTEM"."TEST" ("ID2") 
  PCTFREE 10 INITRANS 2 MAXTRANS 255 COMPUTE STATISTICS 
  STORAGE(INITIAL 65536 NEXT 1048576 MINEXTENTS 1 MAXEXTENTS 2147483645
  PCTINCREASE 0 FREELISTS 1 FREELIST GROUPS 1
  BUFFER_POOL DEFAULT FLASH_CACHE DEFAULT CELL_FLASH_CACHE DEFAULT)
...
--------------------------------------------------------
  ...
  CREATE UNIQUE INDEX "SYSTEM"."SYS_C008315" ON "SYSTEM"."Users" ("EMAIL") 
  PCTFREE 10 INITRANS 2 MAXTRANS 255 COMPUTE STATISTICS 
  STORAGE(INITIAL 65536 NEXT 1048576 MINEXTENTS 1 MAXEXTENTS 2147483645
  PCTINCREASE 0 FREELISTS 1 FREELIST GROUPS 1
  BUFFER_POOL DEFAULT FLASH_CACHE DEFAULT CELL_FLASH_CACHE DEFAULT)
  TABLESPACE "SYSTEM" ;
--------------------------------------------------------
--  DDL for Index USER_GOOGLE_ID
--------------------------------------------------------

  CREATE UNIQUE INDEX "SYSTEM"."USER_GOOGLE_ID" ON "SYSTEM"."Users" ("GOOGLE_ID") 
  PCTFREE 10 INITRANS 2 MAXTRANS 255 COMPUTE STATISTICS 
  STORAGE(INITIAL 65536 NEXT 1048576 MINEXTENTS 1 MAXEXTENTS 2147483645
  PCTINCREASE 0 FREELISTS 1 FREELIST GROUPS 1
  BUFFER_POOL DEFAULT FLASH_CACHE DEFAULT CELL_FLASH_CACHE DEFAULT)
...
--------------------------------------------------------
  ...
  ALTER TABLE "SYSTEM"."BLACKLIST" MODIFY ("MUTED_USERID" NOT NULL ENABLE);
  ALTER TABLE "SYSTEM"."BLACKLIST" ADD PRIMARY KEY ("ID")
  USING INDEX PCTFREE 10 INITRANS 2 MAXTRANS 255 COMPUTE STATISTICS 
  STORAGE(INITIAL 65536 NEXT 1048576 MINEXTENTS 1 MAXEXTENTS 2147483645
  PCTINCREASE 0 FREELISTS 1 FREELIST GROUPS 1
  BUFFER_POOL DEFAULT FLASH_CACHE DEFAULT CELL_FLASH_CACHE DEFAULT)
  TABLESPACE "SYSTEM"  ENABLE;
  ALTER TABLE "SYSTEM"."BLACKLIST" ADD CONSTRAINT "BLACKLIST_UNIQUE_USERID" UNIQUE ("USERID")
  USING INDEX PCTFREE 10 INITRANS 2 MAXTRANS 255 COMPUTE STATISTICS 
  STORAGE(INITIAL 65536 NEXT 1048576 MINEXTENTS 1 MAXEXTENTS 2147483645
  PCTINCREASE 0 FREELISTS 1 FREELIST GROUPS 1
  BUFFER_POOL DEFAULT FLASH_CACHE DEFAULT CELL_FLASH_CACHE DEFAULT)
...
--------------------------------------------------------
  ...
  ALTER TABLE "SYSTEM"."Like" ADD PRIMARY KEY ("LIKEID")
  USING INDEX PCTFREE 10 INITRANS 2 MAXTRANS 255 COMPUTE STATISTICS 
  STORAGE(INITIAL 65536 NEXT 1048576 MINEXTENTS 1 MAXEXTENTS 2147483645
  PCTINCREASE 0 FREELISTS 1 FREELIST GROUPS 1
  BUFFER_POOL DEFAULT FLASH_CACHE DEFAULT CELL_FLASH_CACHE DEFAULT)
  TABLESPACE "SYSTEM"  ENABLE;
  ALTER TABLE "SYSTEM"."Like" ADD CONSTRAINT "LIKE_UNIQUE_USERID" UNIQUE ("USERID")
  USING INDEX PCTFREE 10 INITRANS 2 MAXTRANS 255 COMPUTE STATISTICS 
  STORAGE(INITIAL 65536 NEXT 1048576 MINEXTENTS 1 MAXEXTENTS 2147483645
  PCTINCREASE 0 FREELISTS 1 FREELIST GROUPS 1
  BUFFER_POOL DEFAULT FLASH_CACHE DEFAULT CELL_FLASH_CACHE DEFAULT)
...
--------------------------------------------------------
  ...
  ALTER TABLE "SYSTEM"."FOLLOWER" ADD PRIMARY KEY ("ID")
  USING INDEX PCTFREE 10 INITRANS 2 MAXTRANS 255 COMPUTE STATISTICS 
  STORAGE(INITIAL 65536 NEXT 1048576 MINEXTENTS 1 MAXEXTENTS 2147483645
  PCTINCREASE 0 FREELISTS 1 FREELIST GROUPS 1
  BUFFER_POOL DEFAULT FLASH_CACHE DEFAULT CELL_FLASH_CACHE DEFAULT)
  TABLESPACE "SYSTEM"  ENABLE;
  ALTER TABLE "SYSTEM"."FOLLOWER" ADD CONSTRAINT "FOLLOWER_COMPOSITE_CONSTRAINT" UNIQUE ("USERID", "FOLLOWEDID")
  USING INDEX PCTFREE 10 INITRANS 2 MAXTRANS 255 COMPUTE STATISTICS 
  STORAGE(INITIAL 65536 NEXT 1048576 MINEXTENTS 1 MAXEXTENTS 2147483645
  PCTINCREASE 0 FREELISTS 1 FREELIST GROUPS 1
  BUFFER_POOL DEFAULT FLASH_CACHE DEFAULT CELL_FLASH_CACHE DEFAULT)
...
--------------------------------------------------------
  ...
  ALTER TABLE "SYSTEM"."COMMENTS" MODIFY ("COMMENTID" NOT NULL ENABLE);
  ALTER TABLE "SYSTEM"."COMMENTS" ADD PRIMARY KEY ("COMMENTID")
  USING INDEX PCTFREE 10 INITRANS 2 MAXTRANS 255 COMPUTE STATISTICS 
  STORAGE(INITIAL 65536 NEXT 1048576 MINEXTENTS 1 MAXEXTENTS 2147483645
  PCTINCREASE 0 FREELISTS 1 FREELIST GROUPS 1
  BUFFER_POOL DEFAULT FLASH_CACHE DEFAULT CELL_FLASH_CACHE DEFAULT)
...
--------------------------------------------------------
  ...
  ALTER TABLE "SYSTEM"."PERSONALIZATION" ADD PRIMARY KEY ("ID")
  USING INDEX PCTFREE 10 INITRANS 2 MAXTRANS 255 COMPUTE STATISTICS 
  STORAGE(INITIAL 65536 NEXT 1048576 MINEXTENTS 1 MAXEXTENTS 2147483645
  PCTINCREASE 0 FREELISTS 1 FREELIST GROUPS 1
  BUFFER_POOL DEFAULT FLASH_CACHE DEFAULT CELL_FLASH_CACHE DEFAULT)
...
--------------------------------------------------------
  ...
  ALTER TABLE "SYSTEM"."POST" ADD PRIMARY KEY ("POSTID")
  USING INDEX PCTFREE 10 INITRANS 2 MAXTRANS 255 COMPUTE STATISTICS 
  STORAGE(INITIAL 65536 NEXT 1048576 MINEXTENTS 1 MAXEXTENTS 2147483645
  PCTINCREASE 0 FREELISTS 1 FREELIST GROUPS 1
  BUFFER_POOL DEFAULT FLASH_CACHE DEFAULT CELL_FLASH_CACHE DEFAULT)
...
--------------------------------------------------------
  ...
  ALTER TABLE "SYSTEM"."READING_HISTORY" MODIFY ("USERID" NOT NULL ENABLE);
  ALTER TABLE "SYSTEM"."READING_HISTORY" MODIFY ("POSTID" NOT NULL ENABLE);
  ALTER TABLE "SYSTEM"."READING_HISTORY" ADD PRIMARY KEY ("ID")
  USING INDEX PCTFREE 10 INITRANS 2 MAXTRANS 255 COMPUTE STATISTICS 
  STORAGE(INITIAL 65536 NEXT 1048576 MINEXTENTS 1 MAXEXTENTS 2147483645
  PCTINCREASE 0 FREELISTS 1 FREELIST GROUPS 1
  BUFFER_POOL DEFAULT FLASH_CACHE DEFAULT CELL_FLASH_CACHE DEFAULT)
...
--------------------------------------------------------
  ...
  ALTER TABLE "SYSTEM"."READING_LIST" ADD CHECK ( Published IN ('TRUE','FALSE')) ENABLE;
  ALTER TABLE "SYSTEM"."READING_LIST" ADD PRIMARY KEY ("ID")
  USING INDEX PCTFREE 10 INITRANS 2 MAXTRANS 255 COMPUTE STATISTICS 
  STORAGE(INITIAL 65536 NEXT 1048576 MINEXTENTS 1 MAXEXTENTS 2147483645
  PCTINCREASE 0 FREELISTS 1 FREELIST GROUPS 1
  BUFFER_POOL DEFAULT FLASH_CACHE DEFAULT CELL_FLASH_CACHE DEFAULT)
  TABLESPACE "SYSTEM"  ENABLE;
  ALTER TABLE "SYSTEM"."READING_LIST" ADD CONSTRAINT "READINGLIST_UNIQUE_USERID" UNIQUE ("USERID")
  USING INDEX PCTFREE 10 INITRANS 2 MAXTRANS 255 COMPUTE STATISTICS 
  STORAGE(INITIAL 65536 NEXT 1048576 MINEXTENTS 1 MAXEXTENTS 2147483645
  PCTINCREASE 0 FREELISTS 1 FREELIST GROUPS 1
  BUFFER_POOL DEFAULT FLASH_CACHE DEFAULT CELL_FLASH_CACHE DEFAULT)
  TABLESPACE "SYSTEM"  ENABLE;
--------------------------------------------------------
--  Constraints for Table RELEVANCY_POST_TAG
--------------------------------------------------------

  ALTER TABLE "SYSTEM"."RELEVANCY_POST_TAG" ADD PRIMARY KEY ("ID")
  USING INDEX PCTFREE 10 INITRANS 2 MAXTRANS 255 COMPUTE STATISTICS 
  STORAGE(INITIAL 65536 NEXT 1048576 MINEXTENTS 1 MAXEXTENTS 2147483645
  PCTINCREASE 0 FREELISTS 1 FREELIST GROUPS 1
  BUFFER_POOL DEFAULT FLASH_CACHE DEFAULT CELL_FLASH_CACHE DEFAULT)
...
--------------------------------------------------------
  ...
  ALTER TABLE "SYSTEM"."SETTING" ADD CHECK (Blog_roll IN ('TRUE','FALSE')) ENABLE;
  ALTER TABLE "SYSTEM"."SETTING" ADD PRIMARY KEY ("ID")
  USING INDEX PCTFREE 10 INITRANS 2 MAXTRANS 255 COMPUTE STATISTICS 
  STORAGE(INITIAL 65536 NEXT 1048576 MINEXTENTS 1 MAXEXTENTS 2147483645
  PCTINCREASE 0 FREELISTS 1 FREELIST GROUPS 1
  BUFFER_POOL DEFAULT FLASH_CACHE DEFAULT CELL_FLASH_CACHE DEFAULT)
  TABLESPACE "SYSTEM"  ENABLE;
  ALTER TABLE "SYSTEM"."SETTING" ADD CONSTRAINT "SETTING_UNIQUE_USERID" UNIQUE ("USERID")
  USING INDEX PCTFREE 10 INITRANS 2 MAXTRANS 255 COMPUTE STATISTICS 
  STORAGE(INITIAL 65536 NEXT 1048576 MINEXTENTS 1 MAXEXTENTS 2147483645
  PCTINCREASE 0 FREELISTS 1 FREELIST GROUPS 1
  BUFFER_POOL DEFAULT FLASH_CACHE DEFAULT CELL_FLASH_CACHE DEFAULT)
...
--------------------------------------------------------
  ...
  ALTER TABLE "SYSTEM"."TAG" ADD PRIMARY KEY ("ID")
  USING INDEX PCTFREE 10 INITRANS 2 MAXTRANS 255 COMPUTE STATISTICS 
  STORAGE(INITIAL 65536 NEXT 1048576 MINEXTENTS 1 MAXEXTENTS 2147483645
  PCTINCREASE 0 FREELISTS 1 FREELIST GROUPS 1
  BUFFER_POOL DEFAULT FLASH_CACHE DEFAULT CELL_FLASH_CACHE DEFAULT)
  TABLESPACE "SYSTEM"  ENABLE;
  ALTER TABLE "SYSTEM"."TAG" ADD UNIQUE ("LABEL")
  USING INDEX PCTFREE 10 INITRANS 2 MAXTRANS 255 COMPUTE STATISTICS 
  STORAGE(INITIAL 65536 NEXT 1048576 MINEXTENTS 1 MAXEXTENTS 2147483645
  PCTINCREASE 0 FREELISTS 1 FREELIST GROUPS 1
  BUFFER_POOL DEFAULT FLASH_CACHE DEFAULT CELL_FLASH_CACHE DEFAULT)
...
--------------------------------------------------------
  ...
  ALTER TABLE "SYSTEM"."TEST" ADD UNIQUE ("ID2")
  USING INDEX PCTFREE 10 INITRANS 2 MAXTRANS 255 COMPUTE STATISTICS 
  STORAGE(INITIAL 65536 NEXT 1048576 MINEXTENTS 1 MAXEXTENTS 2147483645
  PCTINCREASE 0 FREELISTS 1 FREELIST GROUPS 1
  BUFFER_POOL DEFAULT FLASH_CACHE DEFAULT CELL_FLASH_CACHE DEFAULT)
...
--------------------------------------------------------
  ...
  BUFFER_POOL DEFAULT FLASH_CACHE DEFAULT CELL_FLASH_CACHE DEFAULT)
  TABLESPACE "SYSTEM"  ENABLE;
  ALTER TABLE "SYSTEM"."Users" ADD CONSTRAINT "USER_GOOGLE_ID" UNIQUE ("GOOGLE_ID")
  USING INDEX PCTFREE 10 INITRANS 2 MAXTRANS 255 COMPUTE STATISTICS 
  STORAGE(INITIAL 65536 NEXT 1048576 MINEXTENTS 1 MAXEXTENTS 2147483645
  PCTINCREASE 0 FREELISTS 1 FREELIST GROUPS 1
  BUFFER_POOL DEFAULT FLASH_CACHE DEFAULT CELL_FLASH_CACHE DEFAULT)
...
--------------------------------------------------------
  ...
  ALTER TABLE "SYSTEM"."BLACKLIST" ADD CONSTRAINT "FK_BLACKLIST_USERID" FOREIGN KEY ("USERID")
	  REFERENCES "SYSTEM"."Users" ("GOOGLE_ID") ENABLE;
  ALTER TABLE "SYSTEM"."BLACKLIST" ADD CONSTRAINT "FKJO7WLY0FERJKWEX1SAM4MTE35" FOREIGN KEY ("USERID")
	  REFERENCES "SYSTEM"."USERS" ("GOOGLE_ID") DISABLE;
--------------------------------------------------------
--  Ref Constraints for Table Like
--------------------------------------------------------

  ALTER TABLE "SYSTEM"."Like" ADD CONSTRAINT "FK_LIKE_USERID" FOREIGN KEY ("USERID")
	  REFERENCES "SYSTEM"."Users" ("GOOGLE_ID") ENABLE;
  ALTER TABLE "SYSTEM"."Like" ADD CONSTRAINT "FK_LIKE_POSTID" FOREIGN KEY ("POSTID")
	  REFERENCES "SYSTEM"."POST" ("POSTID") ENABLE;
--------------------------------------------------------
--  Ref Constraints for Table FOLLOWER
--------------------------------------------------------

  ALTER TABLE "SYSTEM"."FOLLOWER" ADD CONSTRAINT "FK_FOLLOWER_USERID" FOREIGN KEY ("USERID")
	  REFERENCES "SYSTEM"."Users" ("GOOGLE_ID") ENABLE;
  ALTER TABLE "SYSTEM"."FOLLOWER" ADD CONSTRAINT "FKK4LLSAQPFPCUS3JSSYCT22R8A" FOREIGN KEY ("FOLLOWEDID")
	  REFERENCES "SYSTEM"."USERS" ("GOOGLE_ID") DISABLE;
  ALTER TABLE "SYSTEM"."FOLLOWER" ADD CONSTRAINT "FK65XODPPA44YI7L8D8QN0KNM9J" FOREIGN KEY ("USERID")
	  REFERENCES "SYSTEM"."USERS" ("GOOGLE_ID") DISABLE;
--------------------------------------------------------
--  Ref Constraints for Table COMMENTS
--------------------------------------------------------

  ALTER TABLE "SYSTEM"."COMMENTS" ADD CONSTRAINT "FKCDWOHJNXJD7YBHM1JFL8VSIEJ" FOREIGN KEY ("POSTID")
	  REFERENCES "SYSTEM"."POST" ("POSTID") ENABLE;
--------------------------------------------------------
--  Ref Constraints for Table PERSONALIZATION
--------------------------------------------------------

  ALTER TABLE "SYSTEM"."PERSONALIZATION" ADD CONSTRAINT "FK_PERSONALIZATION_USERID" FOREIGN KEY ("USERID")
	  REFERENCES "SYSTEM"."Users" ("GOOGLE_ID") ENABLE;
--------------------------------------------------------
--  Ref Constraints for Table POST
--------------------------------------------------------

  ALTER TABLE "SYSTEM"."POST" ADD CONSTRAINT "FK_POST_USERID" FOREIGN KEY ("USERID")
	  REFERENCES "SYSTEM"."Users" ("GOOGLE_ID") ENABLE;
--------------------------------------------------------
--  Ref Constraints for Table READING_HISTORY
--------------------------------------------------------

  ALTER TABLE "SYSTEM"."READING_HISTORY" ADD CONSTRAINT "FK_READING_HISTORY_USERID" FOREIGN KEY ("USERID")
	  REFERENCES "SYSTEM"."Users" ("GOOGLE_ID") ENABLE;
  ALTER TABLE "SYSTEM"."READING_HISTORY" ADD CONSTRAINT "FK_READING_HISTORY_POSTID" FOREIGN KEY ("POSTID")
	  REFERENCES "SYSTEM"."POST" ("POSTID") ENABLE;
  ALTER TABLE "SYSTEM"."READING_HISTORY" ADD CONSTRAINT "FK4A7TVQRQUNPFHVORV6G1XMSPR" FOREIGN KEY ("USERID")
	  REFERENCES "SYSTEM"."USERS" ("GOOGLE_ID") DISABLE;
--------------------------------------------------------
--  Ref Constraints for Table READING_LIST
--------------------------------------------------------

  ALTER TABLE "SYSTEM"."READING_LIST" ADD CONSTRAINT "FK_READINGLIST_USERID" FOREIGN KEY ("USERID")
	  REFERENCES "SYSTEM"."Users" ("GOOGLE_ID") ENABLE;
  ALTER TABLE "SYSTEM"."READING_LIST" ADD CONSTRAINT "FK_READINGLIST_POSTID" FOREIGN KEY ("POSTID")
	  REFERENCES "SYSTEM"."POST" ("POSTID") ENABLE;
  ALTER TABLE "SYSTEM"."READING_LIST" ADD CONSTRAINT "FKFAK4VKII9KD3QJ2YU9SY11OII" FOREIGN KEY ("USERID")
	  REFERENCES "SYSTEM"."USERS" ("GOOGLE_ID") DISABLE;
--------------------------------------------------------
--  Ref Constraints for Table READING_LIST_POST
--------------------------------------------------------

  ALTER TABLE "SYSTEM"."READING_LIST_POST" ADD CONSTRAINT "FK_READING_LIST_ID" FOREIGN KEY ("READING_LIST_ID")
	  REFERENCES "SYSTEM"."READING_LIST" ("ID") ENABLE;
  ALTER TABLE "SYSTEM"."READING_LIST_POST" ADD CONSTRAINT "FK_READING_LIST_POST_POSTID" FOREIGN KEY ("POSTID")
	  REFERENCES "SYSTEM"."POST" ("POSTID") ENABLE;
--------------------------------------------------------
--  Ref Constraints for Table RELEVANCY_POST_TAG
--------------------------------------------------------

  ALTER TABLE "SYSTEM"."RELEVANCY_POST_TAG" ADD CONSTRAINT "FK_RELEVANCY_POST_TAG_POSTID" FOREIGN KEY ("POSTID")
	  REFERENCES "SYSTEM"."POST" ("POSTID") ENABLE;
  ALTER TABLE "SYSTEM"."RELEVANCY_POST_TAG" ADD CONSTRAINT "FK_RELEVANCY_POST_TAG_TAGID" FOREIGN KEY ("TAGID")
	  REFERENCES "SYSTEM"."TAG" ("ID") ENABLE;
  ALTER TABLE "SYSTEM"."RELEVANCY_POST_TAG" ADD CONSTRAINT "FKG15Q2WT5X9PYJNN2L6E05R614" FOREIGN KEY ("ID")
	  REFERENCES "SYSTEM"."TAG" ("ID") ENABLE;
--------------------------------------------------------
--  Ref Constraints for Table SETTING
--------------------------------------------------------

  ALTER TABLE "SYSTEM"."SETTING" ADD CONSTRAINT "FK_SETTING_USERID" FOREIGN KEY ("USERID")
	  REFERENCES "SYSTEM"."Users" ("GOOGLE_ID") ENABLE;
  ALTER TABLE "SYSTEM"."SETTING" ADD CONSTRAINT "FK57I233928SIMR95BD4U669QKD" FOREIGN KEY ("USERID")
	  REFERENCES "SYSTEM"."USERS" ("GOOGLE_ID") DISABLE;
--------------------------------------------------------
--  Ref Constraints for Table TEST
--------------------------------------------------------

  ALTER TABLE "SYSTEM"."TEST" ADD CONSTRAINT "FK_ID2" FOREIGN KEY ("ID2")
	  REFERENCES "SYSTEM"."POST" ("POSTID") ENABLE;
